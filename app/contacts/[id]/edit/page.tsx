...
export default function EditContactPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const fetchContact = async (id: string) => {
    ...
    setFormData({
      ...
      types: data.types || [],
      vehicle: data.vehicle || "CORE",
      ownerUserId: data.ownerUserId || "",
      capitalPotential: data.capitalPotential || "UNKNOWN",
      equityRollInPotential: data.equityRollInPotential || "UNKNOWN",
      rollInPropertyLocation: data.rollInPropertyLocation || "",
